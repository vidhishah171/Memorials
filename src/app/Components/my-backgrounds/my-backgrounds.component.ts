...
@Component({
  selector: 'app-my-backgrounds',
  templateUrl: './my-backgrounds.component.html',
  styleUrls: ['./my-backgrounds.component.css']
})
export class MyBackgroundsComponent implements OnInit {
  uploadBack: any;
  updateBack: any;
