...
@Component({
  selector: 'app-memory-images',
  templateUrl: './memory-images.component.html',
  styleUrls: ['./memory-images.component.css']
})
export class MemoryImagesComponent implements OnInit {
